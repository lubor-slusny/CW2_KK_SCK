...
if CLIENT then
	...
	SWEP.KKINS2CSTMBarskaPos = Vector(-2.815, -0, -0.3279)
	SWEP.KKINS2CSTMBarskaAng = Vector(0, 0, 0)

	SWEP.KKINS2AimpointPos = Vector(-2.8247, -0, -0.3669)
	SWEP.KKINS2AimpointAng = Vector(0, 0, 0)

	SWEP.KKINS2ScopeMosinPos = Vector(-2.8011, -0, 0.0242)
	SWEP.KKINS2ScopeMosinAng = Vector(0, 0, 0)

	SWEP.KKINS2MagnifierPos = Vector(-2.815, -0, -0.4)
	SWEP.KKINS2MagnifierAng = Vector(0, 0, 0)

	SWEP.KKINS2PSO4Pos = Vector(-2.7506, -0, -0.2107)
	SWEP.KKINS2PSO4Ang = Vector(0, 0, 0)

	SWEP.KKINS2ScopeM40Pos = Vector(-2.8291, -0, -0.2102)
	SWEP.KKINS2ScopeM40Ang = Vector(0, 0, 0)

	SWEP.KKINS2ElcanPos = Vector(-2.8232, -0, -0.7093)
	SWEP.KKINS2ElcanAng = Vector(0, 0, 0)
	
	SWEP.KKINS2CSTMACOGPos = Vector(-2.8198, -0, -0.4165)

...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["pcf"] = {model = "models/maxofs2d/cube_tool.mdl", pos = Vector(0, 0, 0), angle = Angle(0, -90, 0), size = Vector(0.01, 0.01, 0.01), attachment = "tail", bodygroups = {[1] = 1,}, active = true, nodraw = true},
	}

CustomizableWeaponry:addFireSound("CW_KK_INS2_GALIL_FIRE", "weapons/galil/galil_fp.wav", 1, 100, CHAN_STATIC)
CustomizableWeaponry:addFireSound("CW_KK_INS2_GALIL_FIRE_SUPPRESSED", "weapons/galil/galil_suppressed_fp.wav", 1, 70, CHAN_STATIC)

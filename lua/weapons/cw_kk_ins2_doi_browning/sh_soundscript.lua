...
SWEP.Sounds = {
	...
	base_reload = {
		...
		{time = 110/34.8, sound = "", callback = CustomizableWeaponry_KK.ins2.bulletsToReserve},
	...
	base_reload_empty = {
		...
		{time = 100/34.8, sound = "", callback = CustomizableWeaponry_KK.ins2.bulletsToReserve},
	...
	deployed_reload = {
		...
		{time = 110/36, sound = "", callback = CustomizableWeaponry_KK.ins2.bulletsToReserve},
	...
	deployed_reload_empty = {
		...
		{time = 100/36, sound = "", callback = CustomizableWeaponry_KK.ins2.bulletsToReserve},

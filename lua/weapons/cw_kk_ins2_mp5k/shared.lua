...
if CLIENT then
	...
	SWEP.KKINS2MagnifierPos = Vector(-2.3103, -3, 0.0042)
	SWEP.KKINS2MagnifierAng = Vector(-1.5039, 0, 0)
	...
	SWEP.KKINS2PSO4Pos = Vector(-2.2636, -4, 0.2343)
	SWEP.KKINS2PSO4Ang = Vector(-1.4, 0, 0)

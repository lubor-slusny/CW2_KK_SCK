...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["scope_ext"] = {model = "models/weapons/upgrades/a_clothwrap_garand.mdl", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), merge = true, active = true},
...
if CLIENT then
	function SWEP:updateStandardParts()
		-- self:setElementActive("scope_ext", self.ActiveAttachments.kk_ins2_scope_m82)
	end
end

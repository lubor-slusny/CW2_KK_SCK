...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_revolver_mag"] = {model = "models/weapons/upgrades/a_speedloader_mateba.mdl", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.IronsightPos = Vector(-2.0069, 0, 0.1801)
	SWEP.IronsightAng = Vector(0, 0.0008, 0)
...
SWEP.ViewModel		= "models/weapons/v_cw_kk_ins2_cstm_mateba.mdl"

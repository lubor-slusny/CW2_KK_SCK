CustomizableWeaponry:addFireSound("CW_KK_INS2_CSTM_FAMAS_FIRE", "weapons/cw_kk_ins2_cstm_famas/mini14_fp.wav", 1, 105, CHAN_STATIC)
CustomizableWeaponry:addFireSound("CW_KK_INS2_CSTM_FAMAS_FIRE_SUPPRESSED", "weapons/cw_kk_ins2_cstm_famas/mini14_suppressed_fp.wav", 1, 75, CHAN_STATIC)

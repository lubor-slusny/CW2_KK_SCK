...
if CLIENT then
	...
	SWEP.KKINS2PSO4Pos = Vector(-2.4367, -10, 0.1056)
...
SWEP.Attachments = {
	...
	{header = "Sight", offset = {500, -500},  atts = {"kk_ins2_kobra", "kk_ins2_eotech", "kk_ins2_aimpoint", "kk_ins2_elcan", "kk_ins2_pso4", "kk_ins2_scope_m40"}},

...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/upgrades/a_standard_acr.mdl", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), merge = true, active = true},
		...
		["kk_ins2_eotech"] = {model = "models/weapons/upgrades/a_optic_eotech_l.mdl", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), merge = true, retSizeMult = 1.2},
		...
		["kk_ins2_cstm_eotechxps"] = {model = "models/weapons/attachments/v_cw_kk_ins2_cstm_eotechxps.mdl", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), merge = true, retSizeMult = 1.2},
	}

	SWEP.AttachmentModelsWM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/upgrades/w_flipacr.mdl", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), merge = true, active = true},
		
		["kk_ins2_suppressor_sec"] = {model = "models/weapons/upgrades/w_sil_sec2.mdl", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.IronsightPos = Vector(-2.7462, -2, 0.9412)
	SWEP.IronsightAng = Vector(0.0663, 0.0312, 0)

	SWEP.KKINS2KobraPos = Vector(-2.7535, -2, 0.7071)
	SWEP.KKINS2KobraAng = Vector(0, 0.0066, 0)

	SWEP.KKINS2EoTechPos = Vector(-2.739, -2, 0.561)
	SWEP.KKINS2EoTechAng = Vector(0, 0.0066, 0)

	SWEP.KKINS2AimpointPos = Vector(-2.7457, -2, 0.8119)
	SWEP.KKINS2AimpointAng = Vector(0, 0.0175, 0)

	SWEP.KKINS2ElcanPos = Vector(-2.7471, -1, 0.485)
	SWEP.KKINS2ElcanAng = Vector(0, 0, 0)

	SWEP.KKINS2PO4Pos = Vector(-2.6901, -2, 0.9117)
	SWEP.KKINS2PO4Ang = Vector(0, 0, 0)

	SWEP.KKINS2MagnifierPos = Vector(-2.7464, -1, 0.8066)
	SWEP.KKINS2MagnifierAng = Vector(0, 0, 0)

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.753, -2, 0.7888)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector(0, 0.0066, 0)

	SWEP.AlternativePos = Vector(0, -1, 0.6)
...
SWEP.Animations = {
	...
	base_draw = "base_draw",
	base_fire = "base_fire",
	base_fire_aim = {"iron_fire_a","iron_fire_b","iron_fire_c","iron_fire_d","iron_fire_e","iron_fire_f","iron_fire"},
	...
	foregrip_fire_aim = {"foregrip_iron_fire_a","foregrip_iron_fire_b","foregrip_iron_fire_c","foregrip_iron_fire_d","foregrip_iron_fire_e","foregrip_iron_fire_f","foregrip_iron_fire"},
...
SWEP.ViewModel		= "models/weapons/v_cw_kk_ins2_cstm_acr.mdl"
SWEP.WorldModel		= "models/weapons/w_cw_kk_ins2_cstm_acr.mdl"

...
if CLIENT then
	...
	SWEP.KKINS2CSTMBarskaPos = Vector(-2.4877, -2, 0.6744)
	SWEP.KKINS2CSTMBarskaAng = Vector(-0.0596, 0.0273, 0)

	SWEP.KKINS2AimpointPos = Vector(-2.4968, -2, 0.5831)
	SWEP.KKINS2AimpointAng = Vector(0, 0, 0)

	SWEP.KKINS2MagnifierPos = Vector(-2.4914, -2, 0.5701)
	...
	SWEP.KKINS2PSO4Pos = Vector(-2.42, -2, 0.7497)
...
SWEP.Attachments = {
	...
	{header = "Sight", offset = {500, -500},  atts = {"bg_foldsight", "kk_ins2_kobra", "kk_ins2_eotech", "kk_ins2_aimpoint", "kk_ins2_elcan", "kk_ins2_pso4", "kk_ins2_scope_m40"}},

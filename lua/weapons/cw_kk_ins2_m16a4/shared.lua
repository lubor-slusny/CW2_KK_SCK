...
if CLIENT then
	...
	function SWEP:_drawViewModel()
		local state = self.dt.State == CW_CUSTOMIZE
		
		if state then
			self:playAnim("menu", 1, 1)
		else
			if state != olState then
				self:idleAnimFunc()
			end
		end
	...
	SWEP.CustomizePos = Vector(30, -4, 0)
...
SWEP.Attachments = {
	{header = "Sight", offset = {1400, -600}, atts = {"bg_foldsight", "kk_ins2_kobra", "kk_ins2_eotech", "kk_ins2_aimpoint", "kk_ins2_elcan", "kk_ins2_po4", "kk_ins2_scope_m40", "kk_ins2_cstm_cmore", "kk_ins2_cstm_barska", "kk_ins2_cstm_microt1", "kk_ins2_cstm_eotechxps", "kk_ins2_cstm_compm4s", "kk_ins2_cstm_acog"}},
	{header = "Barrel", offset = {-400, -500}, atts = {"kk_ins2_suppressor_sec", "kk_ins2_hoovy"}},
	{header = "Under", offset = {250, 350}, atts = {"kk_ins2_bipod", "kk_ins2_vertgrip", "kk_ins2_gl_m203"}},
	{header = "Lasers", offset = {200, -600}, atts = {"kk_ins2_lam", "kk_ins2_flashlight", "kk_ins2_anpeq15"}},
	{header = "More Sight", offset = {1600, -100}, atts = {"kk_ins2_magnifier"}, dependencies = CustomizableWeaponry_KK.ins2.magnifierDependencies},
	["+use"] = {header = "Sight Contract", offset = {1000, -700}, atts = {"kk_ins2_sights_cstm"}},

...
SWEP.Attachments = {
	...
	-- {header = "Sight", offset = {300, -700}, atts = {"kk_ins2_cstm_cmore", "kk_ins2_cstm_barska", "kk_ins2_cstm_microt1", "kk_ins2_cstm_eotechxps", "kk_ins2_cstm_compm4s", "kk_ins2_cstm_acog"}},
	...
	{header = "More Sight", offset = {600, -100}, atts = {"kk_ins2_magnifier"}, dependencies = CustomizableWeaponry_KK.ins2.magnifierDependencies},
...
SWEP.FirstDeployTime = 2.27
SWEP.DeployTime = 0.61

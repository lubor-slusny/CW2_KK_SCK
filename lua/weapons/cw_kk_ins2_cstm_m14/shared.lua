...
if CLIENT then
	...
	SWEP.KKINS2CSTMBarskaPos = Vector(-2.3804, -3, -0.0314)
	...
	SWEP.KKINS2PSO4Pos = Vector(-2.3354, -5, 0.0746)
	SWEP.KKINS2PSO4Ang = Vector(0, 0, 0)

	SWEP.KKINS2CSTMCMorePos = Vector(-2.3814, -2, -0.009)
...
SWEP.Attachments = {
	...
	{header = "Sight", offset = {400, -500}, atts = {"kk_ins2_kobra", "kk_ins2_cstm_cmore", "kk_ins2_cstm_barska", "kk_ins2_eotech", "kk_ins2_aimpoint", "kk_ins2_elcan", "kk_ins2_pso4"}},

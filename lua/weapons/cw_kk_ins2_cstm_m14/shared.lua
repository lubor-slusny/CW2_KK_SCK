...
if CLIENT then
	...
	SWEP.KKINS2PO4Pos = Vector(-2.3354, -5, 0.0746)
...
SWEP.Attachments = {
	...
	{header = "Sight", offset = {400, -500}, atts = {"kk_ins2_kobra", "kk_ins2_cstm_cmore", "kk_ins2_cstm_barska", "kk_ins2_eotech", "kk_ins2_aimpoint", "kk_ins2_elcan", "kk_ins2_po4"}},

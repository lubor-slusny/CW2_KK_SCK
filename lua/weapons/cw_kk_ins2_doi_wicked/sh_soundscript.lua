...
SWEP.Sounds = {
	...
	base_reload = {
		...
		{time = 50/31.2, sound = "", callback = CustomizableWeaponry_KK.ins2.bulletBgs.beltToReserve},
	...
	base_reloadempty = {
		...
		{time = 50/34.2, sound = "", callback = CustomizableWeaponry_KK.ins2.bulletBgs.beltToReserve},

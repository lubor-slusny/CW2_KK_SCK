...
if CLIENT then
	...
	SWEP.KKINS2PSO4Pos = Vector(-2.7451, -3, 0.4511)
	SWEP.KKINS2PSO4Ang = Vector(0, 0, 0)
...
SWEP.Attachments = {
	...
	{header = "Sight", offset = {600, -500}, atts = {"kk_ins2_kobra", "kk_ins2_eotech", "kk_ins2_aimpoint", "kk_ins2_elcan", "kk_ins2_pso4", "kk_ins2_scope_m40"}},

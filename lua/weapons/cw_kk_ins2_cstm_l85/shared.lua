...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_po4"] = {model = "models/weapons/upgrades/a_optic_po4x24_l.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, retSizeMult = 1.2},
		...
		["kk_ins2_cstm_susat"] = {model = "models/weapons/upgrades/a_optic_susat.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	}

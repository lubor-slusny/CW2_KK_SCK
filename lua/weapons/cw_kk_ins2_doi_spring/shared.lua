...
SWEP.Animations = {
	...
	gl_off_reload = "base_reload_empty_clip",
...
SWEP.ViewModel		= "models/weapons/kk_doi/v_springfield.mdl"
...
SWEP.ReloadTimes = {
	...
	base_reload_empty_clip = {90/33.4, 4.49, KK_INS2_STRIPPERCLIP_UNLOAD_ONE, 27/33.4},

...
SWEP.Sounds = {
	...
	base_reload_empty_clip = {
		{time = 0, sound = "", callback = CustomizableWeaponry_KK.ins2.bulletBgs.bulletsToReserve},
	...
	base_reload_insert = {
		...
		{time = 22/37.2, sound = "", callback = CustomizableWeaponry_KK.ins2.bulletBgs.bulletsToClip},
	},

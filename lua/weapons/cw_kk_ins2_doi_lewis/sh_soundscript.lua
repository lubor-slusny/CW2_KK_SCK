...
SWEP.Sounds = {
	...
	base_reload = {
		...
		{time = 83/31.5, sound = "", callback = CustomizableWeaponry_KK.ins2.bulletBgs.bulletsToReserve},
	...
	deployed_reload = {
		...
		{time = 83/32.5, sound = "", callback = CustomizableWeaponry_KK.ins2.bulletBgs.bulletsToReserve},

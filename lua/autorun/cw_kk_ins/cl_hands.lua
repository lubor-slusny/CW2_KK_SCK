...
if CLIENT then
	...
	if CustomizableWeaponry_KK.ins2.isContentMounted2({Folder = "weapons/cw_kk_ins2_doi_"}) then
	...
	if CustomizableWeaponry_KK.ins2.isContentMounted2({Folder = "weapons/cw_kk_ins2_nam_"}) then

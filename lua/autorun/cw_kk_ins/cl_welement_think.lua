...
if CLIENT then
	...
	-- CustomizableWeaponry_KK.ins2.welementThink:add("cw_kk_ins2_at4", warhead)
	CustomizableWeaponry_KK.ins2.welementThink:add("cw_kk_ins2_rpg", warhead)
	CustomizableWeaponry_KK.ins2.welementThink:add("cw_kk_ins2_doi_piat", warhead)
	CustomizableWeaponry_KK.ins2.welementThink:add("cw_kk_ins2_doi_tankfist", warhead)
	CustomizableWeaponry_KK.ins2.welementThink:add("cw_kk_ins2_doi_zooka", warhead)
	...
	-- CustomizableWeaponry_KK.ins2.welementThink:add("cw_kk_ins2_nade_molotov", grenade)
	-- CustomizableWeaponry_KK.ins2.welementThink:add("cw_kk_ins2_doi_frag_de", grenade)
